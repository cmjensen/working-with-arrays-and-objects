...
// let bobsTotal = purchases.filter(elem => elem.owner === "Bob").reduce((acc, cur) => acc + cur.price)

let bobsTotal = purchases.reduce((acc, cur) => cur.owner === "Bob" ? acc + cur.price : acc, 0)
